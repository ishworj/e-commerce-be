import { findAuthSessionById, findAuthSessionByIdandDelete } from "../models/sessions/AuthSessionModel.js"
...
export const verifyEmail = async (req, res, next) => {
    try {
        ...
        const updatedStatus = await updateUser(unverifiedUser._id, { verified: true })
